...
final List<GuidanceTemplate> kBuiltInTemplates = List.unmodifiable([
  _builtin('builtin_be_polite', 'Be polite',
      'Make the reply polite and respectful.', GuidanceCategory.general),
  _builtin('builtin_keep_short', 'Keep it short',
      'Keep the reply short and clear.', GuidanceCategory.general),
  _builtin('builtin_professional', 'Make it professional',
      'Make the reply sound professional and appropriate for work.',
      GuidanceCategory.professional),
  _builtin('builtin_friendly', 'Make it friendly',
      'Make the reply warm and friendly.', GuidanceCategory.friendly),
  _builtin('builtin_decline', 'Decline politely',
      'Politely decline the request without sounding rude.',
      GuidanceCategory.decline),
  _builtin('builtin_thanks', 'Say thank you',
      'Add appreciation and a polite thank-you.', GuidanceCategory.thanks),
  _builtin('builtin_more_time', 'Ask for more time',
      'Ask for more time while sounding responsible and polite.',
      GuidanceCategory.followUp),
  _builtin('builtin_confident', 'Sound confident',
      'Make the reply sound confident but not aggressive.',
      GuidanceCategory.general),
]);

GuidanceTemplate _builtin(
    String id, String title, String content, GuidanceCategory category) {
