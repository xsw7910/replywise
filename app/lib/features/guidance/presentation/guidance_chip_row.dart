...
class GuidanceChipRow extends ConsumerWidget {
  const GuidanceChipRow({super.key, required this.onSelected});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final quick = state.isLoading
        ? <GuidanceTemplate>[]
        : ref.read(guidanceLibraryControllerProvider.notifier)
            .getQuickTemplates()
            .take(6)
            .toList();
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            ActionChip(
              avatar: const Icon(Icons.library_books_outlined, size: 15),
