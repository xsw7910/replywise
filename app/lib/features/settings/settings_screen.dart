      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                key: const Key('settings-header-icon'),
                width: 36,
                height: 36,
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [Color(0xFFEAF2FF), Color(0xFFE9FAF8)],
              ...
              Expanded(
                child: Text(
                  title,
                  key: const Key('settings-header-title'),
                  maxLines: 2,
...
class _CreditsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFFF8FBFF), Color(0xFFF2FAFF)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
          ...
          final identity = Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [Color(0xFFE9F2FF), Color(0xFFE8FAF8)],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
                ...
                child: const CreditsStatusIcon(
                  key: Key('settings-credits-status-icon'),
                  size: 42,
                ),
              ),
      ...
      child: InkWell(
        ...
        child: Column(
          children: [
            ...
            if (showDivider)
              const Padding(
                padding: EdgeInsets.only(left: 84, right: 14),
                child: Divider(
                  height: 1,
                  thickness: 1,
